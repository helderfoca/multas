    ...
    public class AccountController : Controller {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model) {
            if (ModelState.IsValid) {
                ...
                if (result.Succeeded) {
                    try {
                        // resgistar is dados específicos do utilizador
                        ...
                        // destruir o utilizador
                        /// - gerar mensagem para o ModelError
                        /// - registar na base de dados que ocurreu um erro
                        ///     - data
                        ///     - hora
                        ///     - nome do controller
                        ///     - nome do método
                        ///     - texto com a descrição do erro (ex.message)
                        ///     - outras informações que se considerem necessárias
